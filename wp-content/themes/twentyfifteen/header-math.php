                                            ...
                                            <div class="col-sm-3 col-md-3">
                                                <div class="tooltip tooltip-manage-a-classroom col-xs-12 col-sm-12">
                                                    <a href="#"  id="check-availability" class="check-availability">
                                                        ...
                                                        <span data-toggle="popover" data-placement="bottom" data-container="body" data-trigger="hover" data-html="true" data-max-width="420px" data-content="If username availability is “not available”, someone has already signed up with the email address you entered.<br>If username is “available”, please continue on with the sign up page."></span>
                                                    </a>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div id="totutor" class="col-md-12">
                                                                ...
                                                                <div class="col-md-12 ">
                                                                    ...
                                                                    <div id="extend-tutor3" class="extend-tutor">
                                                                        <div class="teach-ex col-md-12">
                                                                            <h4>Teaching experience in school</h4>
                                                                            <div class="col-sm-6 col-md-6 col-xs-12">
                                                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <span class="color-black">
                                                        <?php
                                                        if ($is_user_logged_in) {
                                                            $date_of_birth = get_user_meta($current_user->ID, 'language_type', true);
                                ...
                                <div id="updateinfo" class="tab-pane fade">
                                    ...
                                    <form method="post" id="myUpdate" action="" name="registerform" enctype="multipart/form-data">
                                        ...
                                        <div class="row" style=" margin-bottom: 20px;">
                                            <div class="col-xs-12 col-sm-8 col-md-8">
                                                <div class="form-group">
                                                    <button id="update-teacher" class="btn-dark-blue" style="background: #f7b555; margin-top: 25px !important; " type="button" name="wp-submit"><?php _e('Update', 'iii-dictionary') ?></button>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <div class="form-group">
...
//            set_lockpage_dialog($title, $body, $return_url);
                                                                        ...
                                                                        <tbody><?php if (empty($user_transactions->items)) : ?>
                                                                                ...
                                                                                foreach ($user_transactions->items as $item) :
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td id="note"><?php echo $item->note ?>
                                                                                            <div id="detail-note"><?php echo $item->note ?></div></td>
                            ...
                            <ul class="nav nav-tabs none-block">
                                <li><a class="header-menu-left" data-toggle="tab" id="myacc">My Account</a>
                                    <ul class="sub-menu-left" id="sub-myacc">
                                        ...
                                        <li id="tutor-regist"><a  data-toggle="tab" href="#tutor-regis-tab">Tutor Registration</a></li>
        ...
        <div class="modal modal-red-brown" id="error-messages-modal" tabindex="-1" role="dialog" aria-hidden="true" style="padding-right: 17px; display: none;">
                ...
                <script type="text/javascript">
                    ...
                    (function ($) {
                        $(function () {
                            ...
                            $('#main-nav-math .nav li a').each(function () {
                                var $this = $(this);
                                ...
                                if (name !== '') {
                                    if ($("#mySidenav").hasClass("open")) {
                                        ...
                                        if ($("#sub-subscription").hasClass("opensub")) {
                                            ...
                                            $('#menu-left-myaccount li:nth-child(5)').css("margin-top", "117px");
                                            $('#menu-left-myaccount li:nth-child(6)').css("margin-top", "7px");
                                        } else {
                                            $('#menu-left-myaccount li:nth-child(2)').css("margin-top", "185px");
                                            $('#menu-left-myaccount li:nth-child(6)').css("margin-top", "3px");
                            ...
                            $("#my-subscription").click(function () {
                                $("#sub-subscription").css("display", "block");
                                $("#sub-subscription").addClass("opensub");
                                $("#sub-myacc").css("display", "none");
                                $("#sub-myacc").removeClass("opensub");
                                $("#sub-lesson-manager").css("display", "none");
                                $("#sub-lesson-manager").removeClass("opensub");
                            ...
                            $("#lesson-manager").click(function () {
                                ...
                                if ($("#mySidenav").hasClass("open")) {
                                    ...
                                    openNav();
                                    $('#menu-left-myaccount li:nth-child(4)').css("margin-top", "117px");
                                    $('#menu-left-myaccount li:nth-child(6)').css("margin-top", "7px");
                                }
                            ...
                            $('#update-teacher').click(function () {
                                ...
                                var last_school = $('#new_ l ast_attended').val();
                            ...
                            $("#select-all-lesson").click(function () {
                                if ($("#select-all-lesson").is(":checked")) {
                                    ...
                                    $(".option-input-lesson").attr("checked", true);
                                } else
                            ...
                            $("#select-all-mylibrary").click(function () {
                            ...
                            $("#tab-public-lib-eng").click(function () {
                                ...
                                if (kt == false)
//                                $("#open-search-eng").addClass(" hidden");
                            ...
                            function getWorksheets(lang, sheet_name, group_name, assignment_id, homework_types, grade, trivia_exclusive, active, cat_level, level, sublevel, type, page) {
                                ...
                                $.get(home_url + "/?r=ajax/get_worksheets", {lang: lang, sheet_name: sheet_name, group_name: group_name, assignment_id: assignment_id, homework_types: homework_types, grade: grade, trivia_exclusive: trivia_exclusive, active: active, cat_level: cat_level, level: level, sublevel: sublevel, type: type, page: page}, function (data) {
                                    ...
                                    if (type == '' || type == 'math') {
                                        ...
                                        //console.log(data.paginate_math);
                                    ...
                                    if (data !== "0") {
                                        ...
                                        if (data.library.length > 0) {
                                            $.each(data.library, function (i, v) {
                                                ...
                                                html += '<div class="delete-worksheet" data-id="' + v.id + '"><img src="<?php echo get_template_directory_uri(); ?>/library/images/icon_Delete_worksheet.png" alt="lesson" ></div>';
                                                html += '<div class="magnifiy-worksheet-ic"><img src="<?php echo get_template_directory_uri(); ?>/library/images/icon_Magnifiy.png" class="" alt="lesson" ></div>';
                                                html += '<div class="detail-worksheet-ic" data-sid="' + v.sheet_id + '" data-desc="' + v.description + '"><img src="<?php echo get_template_directory_uri(); ?>/library/images/Icon_Detail_1.png" class="" alt="lesson" ></div>';
                                                html += '</td>';
                                                html += '</tr>';
...
//search worksheet in my library
                            ...
                            $(".open-arrow-ready-eng").live("click", function () {
                                ...
                                //                            $(".edit-success-ready").attr("data-gid", id);
                                //                            $(".detail-tr-lesson").nextAll(".desc-sheet-ls").remove();
                                var open = $(".eng-tr").not('#eng-tr' + id + '').next().hasClass("detail-tr-lesson");
                                if (open == true) {
                                    //                                $('.open-arrow-ready-eng img').not('#eng-tr' + id + ' .open-arrow-ready-eng img').attr("src", "<?php echo get_template_directory_uri(); ?>/library/images/Icon_Detail_1.png");
...
//                                                          
                            ...
                            $(".lst-worksheet-lesson").live("click", function () {
                                ...
                                //$(".detail-lesson").not('#tr-lesson-' + id + '').next(".desc-lesson-sub").remove();
                                //$(".tr-lesson").nextAll(".detail-worksheet").remove();
...
//                                                          
                            ...
                            $("#search-btn-sub").click(function () {
                                ...
                                tbody_my_lesson.html("");
                                $.post(home_url + "/?r=ajax/get_my_lesson", {search: search}, function (data) {
                                    if (data == 0) {
                                        var tr_m = '<tr><td colspan="6">No results</td></tr>';
                                        tbody_my_lesson.append(tr_m);
                                    } else {
                                        var data = JSON.parse(data);
                                        if (data.lesson.length > 0) {
                                            $.each(data.lesson, function (i, v) {
                                                var html = '';
                                                html += '<tr id="lesson-tr' + v.id + '">';
                                                html += '<td>';
                                                html += ' <div class="cb-type2">';
                                                html += ' <label>';
                                                html += '<input type="checkbox" class="radio_buttons class_cb_search option-input-2 option-input-lesson option-input-lesson-check radio" value="' + v.id + '" name="select-tr"/>';
                                                html += ' </label>';
                                                html += '</div>';
                                                html += ' </td>';
                                                html += '<td class="table-img-icon">';
                                                ...
                                                html += '<td class="table-img-icon">';
                                                html += '<img src="<?php echo get_template_directory_uri(); ?>/library/images/icon_Lesson.png" class="" alt="lesson" >';
                                                html += '<span class="name-lesson">' + v.name + '</span>';
                                                html += ' </td>';
                                                html += '<td class="table-img-icon">';
                                                html += '<div class="delete-worksheet" data-lid=' + v.id + '><img src="<?php echo get_template_directory_uri(); ?>/library/images/icon_Delete_worksheet.png" class="" alt="lesson" ></div>';

                                                html += ' <div class="open-arrow" data-lid="' + v.id + '" data-desc="' + v.description + '" ><img src="<?php echo get_template_directory_uri(); ?>/library/images/icon_Arrow_Open.png" class="" alt="lesson" ></div>';
                                                html += '</td>';
                                                html += '</tr>';
                                                $("#table-less2").append(html);
                                            });
                            ...
                            $(".up-lesson,.down-lesson").live("click", function () {
                                ...
                                var slid = $(this).attr("data-sublid");

                                if ($(this).is(".up-worksheet")) {
                                    if (cls_prev == true) {
                                        $.post(home_url + "/?r=ajax/update_order_lesson", {order: "up", id: slid}, function (data) {
                                            console.log(data);
                                        });
                                        row.insertBefore(row.prev());
                                    ...
                                    if (cls_next == true) {
                                        $.post(home_url + "/?r=ajax/update_order_lesson", {order: "down", id: slid}, function (data) {
                                            console.log(data);
                                        });
                                        row.insertAfter(row.next());
                            ...
                            $(".my-lesson-ws").live("click", function () {
                                ...
                                var id = $(this).attr("data-lid");
                                //$(".tr-lesson").not('#lesson-tr' + id + '').nextAll(".detail-worksheet").remove();
                                //$(".tr-lesson").not('#lesson-tr' + id + '').next(".detail-desc").remove();
                            ...
                            $(".desc-my-lesson").live("click", function () {
                                var id = $(this).attr("data-lid");
                                var desc = $(this).attr("data-desc");
                                // $(".lesson-tr").nextAll(".desc-sheet-ls").remove();
                                var open = $(".lesson-tr").not('#lesson-tr' + id + '').next().hasClass("detail-tr-lesson");
                                if (open == true) {
                                    $(".lesson-tr").not('#lesson-tr' + id + '').nextAll(".detail-tr-lesson").remove();
                                } else {
                                    ...
                                    $.each(dt.arr, function (i, v) {
                                        ...
                                        html += '<tr id="math-tr' + v.id + '" class="math-tr">\n\
                                                                    <td >\n\
                                                                        <div class="cb-type2">\n\
                                                                            <label>\n\
                                                                                <input type="checkbox" class="radio_buttons class_cb_search option-input-2 option-input-lesson option-input-ready-eng radio" value="' + v.id + '" data-cate="5" data-name="' + v.name + '" data-desc="' + v.content + '" name="select-tr"/>\n\
                                                                            </label>\n\
                                                                        </div>\n\
                                                                    </td>';
                                        html += '<td class="table-img-icon">';
                        ...
                        $("#icon-option-ready-eng").click(function () {
                            ...
                            $("#icon-option-ready-math").click(function () {
                                var sort = $(this).attr("data-sort");
                                $.post(home_url + "/?r=ajax/get_groups_home_math", {sort: sort}, function (data) {
                                    $("#table-ready-lesson-math").html('');
                                    if (data !== "0") {
                                        if (sort == "upward") {
                                            $("#icon-option-ready-math").attr("data-sort", "downward");
                                            $(".img-sort-math").attr("src", "<?php echo get_template_directory_uri(); ?>/library/images/icon_Oldest.png");
                                        } else if (sort == "downward") {
                                            $("#icon-option-ready-math").attr("data-sort", "upward");
                                            $(".img-sort-math").attr("src", "<?php echo get_template_directory_uri(); ?>/library/images/icon_Newest.png");
                                        }
                                        var dt = JSON.parse(data);
                                        $.each(dt.arr, function (i, v) {
                                            var html = '';
                                            html += '<tr id="math-tr' + v.id + '" class="math-tr">\n\
                                                                <td >\n\
                                                                    <div class="cb-type2">\n\
                                                                        <label>\n\
                                                                            <input type="checkbox" class="radio_buttons class_cb_search option-input-2 option-input-lesson option-input-ready-math radio" value="' + v.id + '" data-cate="5" data-name="' + v.name + '" data-desc="' + v.content + '" name="select-tr"/>\n\
                                                                        </label>\n\
                                                                    </div>\n\
                                                                </td>';
                                            html += '<td class="table-img-icon">';
                                        ...
                                        $.each(data, function (i, v) {
                                            ...
                                            html += '<tr id="math-tr' + v.id + '" class="math-tr">\n\
                                                                <td >\n\
                                                                    <div class="cb-type2">\n\
                                                                        <label>\n\
                                                                            <input type="checkbox" class="radio_buttons class_cb_search option-input-2 option-input-lesson option-input-dict radio" value="' + v.id + '" data-cate="8" data-name="' + v.name + '" data-desc="" name="select-tr"/>\n\
                                                                        </label>\n\
                                                                    </div>\n\
                                                                </td>';
                                            html += '<td class="table-img-icon">';
