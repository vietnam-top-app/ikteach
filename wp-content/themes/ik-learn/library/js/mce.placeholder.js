(function () {
	tinymce.PluginManager.add( 'placeholder', function ( editor ) {
		...
		var Label = function () {
			...
			attrs = {id: 'mce-placeholder-plugin-label', style: {position: 'absolute', top: '2px', left: '10px', color: '#a4a4a4', padding: '9px 10px', width: '98%', overflow: 'hidden', display: 'none' }};
		...
		Label.prototype.check = function () {
			...
			if ( editor.getContent() == '' && actual_html == '' ) {
				this.show();
			} else {
				this.hide();
			}
