...
if ($segment[2] == 'mathteacher') {
    ...
    <main class="home home-pc-tablet" id="home" >
        ...
        <p id="p2-link-start"><a class="a-link-start" id="a-link-managercourse" href="<?php echo site_home_url(); ?>/?r=teachers-box"></a></p>
        <p id="p3-link-start"><a class="a-link-start" id="a-link-schedule" href="<?php echo site_home_url(); ?>/?r=teaching/teach-class"></a></p>
...
if ($newuser == 1) : ?>
    <!-- <div id="signup-success-dialog" class="modal modal-red-brown" aria-hidden="true"  style="display: none;z-index: 3000;">
        <div class="modal-dialog">
            <div class="modal-contents" style="margin-top: 0;">
                <div class="modal-body">
                    <p class="text-used">Basic Account has been created successfully</p>
                    <button id="got-home" type="button" class="btn-orange btn-create-lesson form-control nopadding-r border-btn">Got it</button>
