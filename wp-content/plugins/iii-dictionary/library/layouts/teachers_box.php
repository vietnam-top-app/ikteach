                                        ...
                                        <div id="available-worksheet-tabs">	
                                            ...
                                            <div class="tab-content row">
                                                <div class="tab-pane active" id="english-tab">
                                                    <div class="col-sm-9 col-md-9">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" value="" placeholder="Worksheet Name" id="filter-worksheet-en">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3 col-md-3 button-mobile">
                                                        <div class="form-group">
                                                            <button type="submit" name="submit" id="btn-search-english" class="create-a-class-btn">Search</button>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row tiny-gutter" style="margin-top: 15px;">
                                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                                    <?php MWHtml::sel_assignments($filter['assignment-id'], false, array(), 'Assignment', 'filter[assignment-id]', 'form-control', 'filter-assignment-en') ?>
                                                                </div>
                                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                                    <?php
                                                                    MWHtml::sel_homework_types($filter['homework-types'], array('first_option' => __('Homework Type', 'iii-dictionary'),
                                                                        ...
                                                                        'id' => 'filter-homework-types-en', 'subscribed_option' => true,
                                                                        'admin_panel' => true)
                                                                    )
                                                                    ?>
                                                                </div>
                                                                <div class="col-xs-12 col-sm-4 col-md-4">
<?php MWHtml::select_grades('ENGLISH', $filter['grade'], array('first_option' => 'Grade', 'class' => 'form-control', 'name' => 'filter[grade]', 'id' => 'grade-en')) ?>
                                                                </div>

                                                            </div>
                                                            <div class="row tiny-gutter" style="margin-top: 20px">
                                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                                    <select class="select-box-it form-control" name="filter[trivia-exclusive]" id="filter-trivia-exclusive-en">
                                                                ...
                                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                                    <select class="select-box-it form-control" name="filter[active]" id="filter-active-en">
                                                            ...
                                                            <div class="col-md-12" style="overflow-y: auto;height: 500px;">
                                                                <div id="table-manage-your-classes" class="table-responsive all-table-create-class">
                                                                    <table class="table table-striped table-sm">
                                                                        ...
                                                                        <tbody id="result-english-search">                                                    
                                                                        </tbody>
                                                                    </table>
                                                                </div>                                                                
                                                            </div>
        ...
        $(function () {
            ...
            $(".icon-close-classes-created").each(function (index) {
                $(this).on("click", function () {
                    ...
                    $(".view-student").prop( "disabled", false );
                    $(".view-assignment").prop( "disabled", false );
                    $(".view-ud-subscription").prop( "disabled", false );
                });                
            });
            ...
            $(".view-student").click(function () {
                ...
                if(!check){
                    $(".view-student").prop( "disabled", true );
                    $(".view-assignment").prop( "disabled", true );
                    $(".view-ud-subscription").prop( "disabled", true );
                }else{
                    $(".view-student").prop( "disabled", false );
                    $(".view-assignment").prop( "disabled", false );
                    $(".view-ud-subscription").prop( "disabled", false );
...
//                            if ($.trim(data) == 'ok') $('#modal-send-message').modal('show');
                            if ($.trim(data) == '1') {
                                $.get(home_url + "/?r=ajax/get_message_sent", {gid: sl}, function (result) {
                                    $('#table-message-sent').html(result);
                                    $('.del-subject').click(function (e) {
                                        var mid = $(this).attr('data-id');
                        ...
                        $.post(home_url + "/?r=ajax/save_message", {
                            ...
                            if ($.trim(data) == '1'){
                                $.get(home_url + "/?r=ajax/get_message_sent", {gid: id}, function (result) {
                                    $('#table-message-sent').html(result);
                                    $('.del-subject').click(function (e) {
                                        var mid = $(this).attr('data-id');
                                        var type = $(this).attr('data-type');
            ...
            $(".bd-new-assignment-modal-lg").on("show.bs.modal",function(){                
                var cat_level = '';
                var level = '';
                var sublevel = '';
                var lang = '';
            ...
            $('#btn-search-math').click(function (e) {
                var assignment_id = $('#math-assignmentsSelectBoxItText').attr('data-val');
                var cat_level = $('#sel-level-categoriesSelectBoxItText').attr('data-val');
                var homework_types = $('#filter-homework-types-mathSelectBoxItText').attr('data-val');
                var level = $('#sel-levelsSelectBoxItText').attr('data-val');
                var sublevel = $('#sel-sublevelsSelectBoxItText').attr('data-val');
            ...
            $('#btn-search-english').click(function (e) {
                var assignment_id = $('#filter-assignment-enSelectBoxItText').attr('data-val');
                var cat_level = '';
                var homework_types = $('#filter-homework-types-enSelectBoxItText').attr('data-val');
                var level = '';
                var sublevel = '';
                var lang = $('#sel-langSelectBoxItText').attr('data-val');
                var sheet_name = $('#filte-sheet-name').val();
                var group_name = '';
                var grade = $('#grade-enSelectBoxItText').attr('data-val');
                var trivia_exclusive = $('#filter-trivia-exclusive-enSelectBoxItText').attr('data-val');
                var active = $('#filter-active-enSelectBoxItText').attr('data-val');
                var type = 'english';

                getWorksheets(lang, sheet_name, group_name, assignment_id, homework_types, grade, trivia_exclusive, active, cat_level, level, sublevel, type);               
            });

            function getWorksheets(lang, sheet_name, group_name, assignment_id, homework_types, grade, trivia_exclusive, active, cat_level, level, sublevel, type){
                var tbody_math = $("#result-math-search");                
                var tbody_english = $("#result-english-search");
                tbody_math.html("");
                tbody_english.html("");

                $.get(home_url + "/?r=ajax/get_worksheets", {lang: lang, sheet_name: sheet_name, group_name: group_name, assignment_id: assignment_id, homework_types: homework_types, grade: grade, trivia_exclusive: trivia_exclusive, active: active, cat_level: cat_level, level: level, sublevel: sublevel, type: type}, function (data) {
                    data = JSON.parse(data);
                    if(type == '' || type == 'english'){
                        if (data.english.length > 0) {
                            $.each(data.english, function (i, v) {
                                var tr_e = '<tr class="' + v.class + '" data-id="' + v.id + '" data-assignment="' + v.assignment+ '"><td style="width: 150px !important;">' + v.assignment + '</td><td style="width: 115px !important;">' + v.grade + '</td><td class="hidden-xs" style="width: 12% !important">' + v.sheet_name + '</td><td class="hidden-xs">' + v.homework_type + '</td><td>' + v.sheet_name + '</td><td class="op-new-assign"><a class="view-assign-homework" data-toggle="modal" data-target=".bd-assign-modal-lg" data-sheet-name="' + v.sheet_name + '" data-sheet-id="' + v.id + '"><img class="img-height-17" src="<?php echo get_template_directory_uri(); ?>/library/images/icon_assign.png"></a><a data-toggle="modal" data-target=".bd-preview-modal-lg" style="margin-left: 10px;"><img class="img-height-17"  src="<?php echo get_template_directory_uri(); ?>/library/images/icon_preview2.png"></a></td></tr>';
                            ...
                            var tr_e = '<tr><td colspan="5">No results.</td><td class="op-new-assign" style="background: #dfdfdf; height: auto;"><a><img class="img-height-20" src="<?php echo get_template_directory_uri(); ?>/library/images/icon_assign_gray.png"></a><a style="margin-left: 10px;"><img class="img-height-24"  src="<?php echo get_template_directory_uri(); ?>/library/images/icon_preview2_gray.png"></a></td></tr>';
                            tbody_english.append(tr_e);
                            for(var i = 0;i < 11; i++){
                                var add_tr_e = '<tr><td>&nbsp</td><td></td><td></td><td></td><td></td><td></td></tr>';
                                tbody_english.append(add_tr_e);
                    ...
                    if(type == '' || type == 'math'){
                        if (data.math.length > 0) {
                            $.each(data.math, function (i, v) {
                                var tr_m = '<tr class="' + v.class + '" data-id="' + v.id + '" data-assignment="' + v.assignment+ '"><td>' + v.level_category_name + '</td><td>' + v.level_name + '</td><td>' + v.sublevel_name + '</td><td>' + v.type + '</td><td>' + v.sheet_name + '</td><td class="op-new-assign"><a class="view-assign-homework" data-toggle="modal" data-target=".bd-assign-modal-lg" data-sheet-name="' + v.sheet_name + '" data-sheet-id="' + v.id + '"><img class="img-height-20" src="<?php echo get_template_directory_uri(); ?>/library/images/icon_assign.png"></a><a data-toggle="modal" data-target=".bd-preview-modal-lg" style="margin-left: 10px;"><img class="img-height-24"  src="<?php echo get_template_directory_uri(); ?>/library/images/icon_preview2.png"></a></td></tr>';
                            ...
                            var tr_m = '<tr><td colspan="5">No results</td><td class="op-new-assign" style="background: #dfdfdf; height: auto;"><a><img class="img-height-20" src="<?php echo get_template_directory_uri(); ?>/library/images/icon_assign_gray.png"></a><a style="margin-left: 10px;"><img class="img-height-24"  src="<?php echo get_template_directory_uri(); ?>/library/images/icon_preview2_gray.png"></a></td></tr>';
                            tbody_math.append(tr_m);
                            for(var i = 0;i < 11; i++){
                                var add_tr_m = '<tr><td>&nbsp</td><td></td><td></td><td></td><td></td><td></td></tr>';
                                tbody_math.append(add_tr_m);
            ...
            function getData(gid){
                var tbody_posting = $("#table-postings-class");                
                var tbody_receive = $("#table-message-receive");
                var tbody_sent = $("#table-message-sent");
                var tbody_student_list = $("#table-student-list");
                var tbody_students = $("#classes-detail-list-students tbody");
                var tbody_assign = $("#table-classes-assign tbody");

                tbody_posting.html("");
                tbody_receive.html("");
                tbody_students.html("");
                tbody_sent.html("");
                tbody_student_list.html("");
                tbody_assign.html("");
                ...
                $.get(home_url + "/?r=ajax/get_message_center", {gid: gid}, function (data) {
                    ...
                    if (data.postings.length > 0) {
                        $.each(data.postings, function (i, v) {
                            var tr_p = '<tr><td class="subject-posting" data-id="' + v.id + '" data-subject="' + v.subject + '"  data-student="' + v.student + '" data-date="' + v.date + '" data-message="' + v.message + '">' + v.subject + '</td><td>' + v.student + '</td><td>' + v.date + '</td><td class="del-subject-posting" data-id="' + v.id + '" style="width: 50px;border-left: 3px solid #ffffff !important; text-align: center; cursor: pointer;"></td></tr>';
                    ...
                    if (data.receives.length > 0) {
                        $.each(data.receives, function (i, v) {
                            var tr_r = '<tr><td class="subject" data-id="' + v.id + '" data-subject="' + v.subject + '"  data-sender="' + v.sender + '" data-receivedDate="' + v.receivedDate + '" data-message="' + v.message + '">' + v.subject + '</td><td>' + v.sender + '</td><td>' + v.receivedDate + '</td><td class="del-subject" data-id="' + v.id + '" data-type="receive" style="width: 50px;border-left: 3px solid #ffffff !important; text-align: center; cursor: pointer;"></td></tr>';
                    ...
                    if (data.sents.length > 0) {
                        $.each(data.sents, function (i, v) {
                            var tr_st = '<tr><td class="subject-sent" data-id="' + v.id + '" data-subject="' + v.subject + '"  data-sender="' + v.sender + '" data-sentDate="' + v.sent_on + '" data-message="' + v.message + '">' + v.subject + '</td><td>' + v.sender + '</td><td>' + v.sent_on + '</td><td class="del-subject" data-id="' + v.id + '" data-type="sent" style="width: 50px;border-left: 3px solid #ffffff !important; text-align: center; cursor: pointer;"></td></tr>';
                    ...
                    if (data.students.length > 0) {
                        ...
                        $('#select-student-list').html(html).data("selectBox-selectBoxIt").refresh();

                        $.each(data.students, function (i, v) {
                            var tr_s = "<tr><td>" + v.display_name + "</td><td>" + v.email + "</td><td>" + v.joined_date + "</td><td>" + v.done_hw + "</td></tr>";
                            tbody_students.append(tr_s);

                            var tr_sl = '<tr><td>' + v.display_name + '</td><td>' + v.email + '</td><td>' + v.joined_date + '</td><td>' + v.user_registered + '</td><td class="student-post" data-id="' + v.id + '" style="width: 50px;border-left: 3px solid #ffffff !important; text-align: center; cursor: pointer;"></td></tr>';
                            tbody_student_list.append(tr_sl); 
                        });

                        for(var i = data.students.length;i < 11; i++){
                            var add_tr_sl = '<tr><td>&nbsp</td><td></td><td></td><td></td><td></td></tr>';
                            tbody_student_list.append(add_tr_sl);
                        }
                        ...
                        var tr_s = "<tr><td colspan='4'>" + JS_MESSAGES.empty_group + "</td></tr>";
                        tbody_students.append(tr_s);

                        var tr_sl = '<tr><td>There is no students yet.</td><td></td><td></td><td></td><td class="no-message"></td></tr>';
                        tbody_student_list.append(tr_sl);
                        for(var i = 0;i < 10; i++){
                            var add_tr_sl = '<tr><td>&nbsp</td><td></td><td></td><td></td><td></td></tr>';
                            tbody_student_list.append(add_tr_sl);
                    ...
                    if (data.assignments.length > 0) {
                        $.each(data.assignments, function (i, v) {
                            ...
                            var tr_a = "<tr><td class='td-check-active-icon' style='padding-left:0px !important;'><div class='tooltip tooltip-classes-created col-xs-12 col-sm-12'><img class='img-assign-classes-created' style='height: 18px;' src='<?php echo get_template_directory_uri(); ?>/library/images/" + src_check_active + "'><div class='tooltip-div tooltip-div-assign'><div class='active-popup'><p>This is newly added worksheet. After updating the detail, you can either Activate or Deactivate the worksheet.</p></div></div></td><td>" + v.grade + "</td><td>" + v.name + "</td><td>" + v.assigned_date + "</td><td>" + v.deadline + "</td><td class='op-col-assign'><a class='view-ud-homework' data-toggle='modal' data-target='.bd-update-homework-modal-lg' data-sheet-id=" + v.sheet_id + "  data-assignment-id=" + v.id + "><img src='<?php echo get_template_directory_uri(); ?>/library/images/icon_n_update.png' style='height:23px;'></a></td></tr>";
                        
                            tbody_assign.append(tr_a);                        
                        });
                        for(var i = data.assignments.length;i < 10; i++){
                            var add_tr_a = '<tr><td colspan="6">&nbsp&nbsp</td></tr>';
                            tbody_assign.append(add_tr_a);
                        }
                    }else{
                        var tr_a = "<tr><td class='td-check-active-icon' style='padding-left:0px !important;'><div class='tooltip tooltip-classes-created col-xs-12 col-sm-12'><img class='img-assign-classes-created' style='height: 18px;' src='<?php echo get_template_directory_uri(); ?>/library/images/icon_inactive_gray.png'></div></td><td colspan='4'>" + JS_MESSAGES.empty_assignment + "</td><td style='background:#dfdfdf;' class='op-col-assign'><a><img src='<?php echo get_template_directory_uri(); ?>/library/images/icon_n_update_gray.png' style='height:23px;'></a></td></tr>";
                        tbody_assign.append(tr_a);
                        for(var i = 0;i < 10; i++){
                            var add_tr_a = '<tr><td colspan="6">&nbsp&nbsp</td></tr>';
                            tbody_assign.append(add_tr_a);
