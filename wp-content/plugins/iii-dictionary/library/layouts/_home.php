...
if ($segment[2] == 'mathteacher') {
    ...
    <main class="home home-pc-tablet" id="home" >
        ...
        <p id="p3-link-start"><a class="a-link-start" href="<?php echo site_home_url(); ?>/?r=my-account#4"></a></p>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-11">
                            ...
                            <p><?php _e('Your account has been created successfully and is ready to use. Please go to My Account for what you can do. Go to', 'iii-dictionary') ?><a class="view-my-account"><?php _e(' My Account.', 'iii-dictionary')?></a></p>
                        </div>
